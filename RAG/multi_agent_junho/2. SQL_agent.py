...
if __name__ == "__main__":
    ...
    queries = [
            ...
            "우리은행 위비 모바일통장 제한사항 상세 설명.",  # ✅ 은행명 + 상품이름 + 조항이름
            "우리은행의 위비 모바일통장 제한사항 상세 설명.",
            "우리은행의 위비 모바일통장에서 제한사항 상세 설명.",
            "우리은행의 위비 모바일통장에서 제한사항을 상세 설명해줘.",
            "국민은행에서 KB스타 건강적금 6조항에 대해 알려줘."
        ]

    for q in queries:
            print("\n===============================")
            print("💬 사용자 질의:", q)
            out = agent.query_database(q.replace("에서", "")) # "에서"라는 조사를 붙였을 때, 키워드 탐지 문제 개선하고자 함!!
